            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 order-4 order-md-1 order-lg-4 order-xl-1">
                        ...
                        <p class="footer__tagline">Stream thousands of movies and TV shows for free on FlixTV.</p>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                        <div class="row">
                            <div class="col-12">
                                <h6 class="footer__title">TV Shows</h6>
                            </div>

                            <div class="col-6">
                                <div class="footer__nav">
                                    <a href="/shows/popular">Popular Shows</a>
                                    <a href="/shows/airing_today">Airing Today</a>
                                    <a href="/shows/on_the_air">On The Air</a>
                                    <a href="/shows/top_rated">Top Shows</a>
                                </div>
                            </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
                        ...
                        <div class="footer__nav">
                            ...
                            <a href="<?= htmlspecialchars($githubURL); ?>" target="_blank">GitHub Repo</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer__content">
                            ...
                            <small class="footer__copyright">Created by <a href="<?= htmlspecialchars($authorURL); ?>" target="_blank"><?= htmlspecialchars($authorName); ?></a> © <?= date('Y'); ?>.</small>
                            </div>
                            <small class="footer__copyright">Disclaimer! This website relies on <a href="https://www.themoviedb.org/" target="_blank">TMDB</a> and other third-party sources for data, rather than hosting it on our servers.</small>
                        </div>
                    </div>
                </div>
